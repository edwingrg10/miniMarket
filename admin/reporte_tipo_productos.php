        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Tipo Productos</h6>
              <div class="d-flex justify-content-end">
                <a class="btn btn-primary" href="reports_pdf/tipo_producto_pdf.php" target="_blank" role="button"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-down-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
