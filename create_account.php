              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" action="#" method="post">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="email" id="email" required="required" placeholder="Correo electronico" autofocus required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="button-panel">
                      <input class="btn btn-primary btn-user btn-block" type="submit" class="button" title="Log In" name="login" value="Registrarse"></input>
                    </div><br>
                    <div class="text-center">
