                                            ...
                                            <div class="col-lg-8">
                                                <div class="p-5">
                                                    ...
                                                    <form class="user" name="Insertar_producto" action="" method="post">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                <input type="text" class="form-control form-control-user" name="precio" id="precio" placeholder="Precio" value="<?= (isset($precio) && !$frm_enviado) ? $precio : "" ?>">
                                                            </div>
                                                        </div>
                                                        <span class="text-danger"><?php echo $error_precio; ?></span>
                                                        <div class="form-group row">
                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                <input type="text" class="form-control form-control-user" name="cantidad_disponible" id="cantidad_disponible" placeholder="Cantidad Disponible" value="<?= (isset($cantidad) && !$frm_enviado) ? $cantidad : "" ?>">
                                                            </div>
                                                        </div>
